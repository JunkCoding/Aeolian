...
double computeSolarAngle(double, double, int, time_t);
...
double computeSolarAngle(double latitude, double longitude, int isSunrise, time_t relativeTo)
{
  double timet = getTime(relativeTo);
  timet = timet - modD(timet, 86400);
...
{
  return computeSolarAngle(latitude, longitude, 1, relativeTo);
}

double sunset(double latitude, double longitude, time_t relativeTo)
{
  return computeSolarAngle(latitude, longitude, 0, relativeTo);
}
